                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a href="<?= base_url('admin/absensi/rekapSesi/' . $s['id']) ?>" 
                                   style="display:inline-block;padding:8px 16px;background:#2563EB;color:white;border-radius:6px;text-decoration:none;font-size:13px;font-weight:600;white-space:nowrap;">
...
<div class="card" style="margin-top:16px;">
    <div class="card-body" style="background:#EFF6FF;border-radius:12px;padding:16px;">
        <p style="margin:0;color:#2563EB;font-size:13px;">
            <i class="fas fa-info-circle"></i> 
            Klik tombol <strong>Detail</strong> untuk melihat daftar siswa yang sudah absen di setiap sesi.
        </p>
    </div>
</div>